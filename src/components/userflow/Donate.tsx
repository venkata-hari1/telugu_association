...
const Donate = () => {
    ...
    const validateField = (name: string, value: string): string => {
        switch (name) {
            ...
            case 'donationAmount':
                ...
                return isNaN(amount) || amount < 5 ? 'Donation amount must be at least $5.00' : '';
            case 'paymentMethod':
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (name === 'donationAmount') {
            ...
            setFormData(prev => ({ ...prev, donationAmount: value, totalAmount: total }));

        } else if (name === 'paymentMethod') {
            setPaymentValue(value);
            setFormData(prev => ({ ...prev, paymentMethod: value }));
            setErrors(prev => ({ ...prev, paymentMethod: validateField('paymentMethod', value) }));
        } else {
    ...
    return (
        <Box p={2}>
            ...
            <Box component={Paper}  mt={2} sx={{padding:'10px',display:'flex',justifyItems:'center',justifyContent:'center',alignItems:'center' }}>
                <Box sx={{width:'90%', display:'grid',gridTemplateColumns:{lg:'80% 20%',xs:'100%',md:'100%'}}}>
                ...
                <Box sx={{ display: "flex", height: "40px" ,mt:{xs:1,md:1}}}>
                    ...
                    <Box
                        sx={{
                            ...
                            border: errors.donationAmount ? "1px solid red" : "1px solid #3DB80C",
                            borderRight: "none",
                        }}
                    >
                    ...
                    <TextField
                        ...
                        error={!!errors.donationAmount && parseFloat(formData.donationAmount || '0') < 5}
                        helperText={
                            !!errors.donationAmount && parseFloat(formData.donationAmount || '0') < 5
            ...
            <Box sx={{ width: '100%', display: 'flex', justifyContent: 'flex-end',mb:2 }}>
                <Typography sx={{ fontSize: '12px', fontWeight: 550, mt: 1, color: '#F4260A' }}>
                    Note: Donation amount should be min of a $5.00
                </Typography>
            </Box>
            {/* Form fields */}
            <Box component={Paper} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', p: { xs: '20px', md: '20px', lg: '20px' } }}>
                <Box sx={{ width: { lg: '90%', xs: '98%', md: '98%' }, ml: { lg: 1, xs: 0, md: 0 } }}>
                    <Box sx={{ width: '100%', display: 'grid', gridTemplateColumns: { lg: '49% 49%', xs: '100%', md: '100%' },gridGap: '2%', mb: 2 }}>
                        {/* Donation Amount */}
                        ...
                        >
                            <Box
                                sx={{
                                    ...
                                    alignItems: 'center',
                                    border: errors.paymentMethod ? "1px solid red" : "1px solid #3DB80C",
                                    p: 2,
                                    width: '100%',
                                }}
                            >
                                ...
                                <Box display="flex" flexDirection="column" alignItems="center" width={{ lg: "200px", xs: '100%' }}>
                                        ...
                                        <TextField
                                            ...
                                            sx={{
                                                "& .MuiOutlinedInput-root": {
                                                    ...
                                                    borderBottomRightRadius: "8px",
                                                    height: "100%",
                                                    "& fieldset": { borderColor: errors.donationAmount ? "red" : "#3DB80C" },
                                                    "&:hover fieldset": { borderColor: errors.donationAmount ? "red" : "#3DB80C" },
                                                    "&.Mui-focused fieldset": { borderColor: errors.donationAmount ? "red" : "#3DB80C" },
                                                },
                                            }}
                                        />
                                    </Box>
