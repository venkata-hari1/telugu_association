...
const Dashboard = () => {
  ...
  const boarddata = [
    { id: 1, icon: <GroupIcon />, title: "Active Members", number: 50 },
    {
      ...
      title: "Total Upcomming Events",
      number: 5,
    },
    { id: 3, icon: <AttachMoneyIcon />, title: "Total Sponsors", number: 50 },
  ];
    ...
    <Box>
      ...
      <Grid container>
        <Grid size={{ lg: 8, md: 8, xs: 12 }}>
          <Box
            sx={{ display: "flex", width: "95%", flexDirection: "row", gap: 2 }}
          >
            {boarddata.map((board) => {
              return (
                <Card sx={{ width: "100%", border: "1px solid #3DB80C" }}>
        ...
        <Grid size={{ lg: 4, md: 4, xs: 12 }}>
          ...
          >
            ...
            <Box display="flex" alignItems="center" mb={2}>
              ...
              <Typography
                variant="h6"
                sx={{ color: "#3DB80C", fontWeight: 500 }}
              >
